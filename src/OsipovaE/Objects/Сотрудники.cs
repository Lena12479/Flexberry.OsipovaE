...
namespace IIS.OsipovaE
{
    ...
    [View("СотрудникиE", new string[] {
            "ФИОсотрудника as \'Ф и осотрудника\'",
    ...
    public class Сотрудники : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиE", typeof(IIS.OsipovaE.Сотрудники));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникиL", typeof(IIS.OsipovaE.Сотрудники));
                }
            }
        }
    }
